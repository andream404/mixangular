'use strict'
var kamApp = angular.module('AngularJSApp', ['ngResource','ngRoute','ngCookies','angular-md5','ngAnimate','oc.lazyLoad','ui.router','ui.utils','ui.select','ui.bootstrap','ngSanitize']);
